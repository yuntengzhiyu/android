<template>
	<view>
		...
		<view class="qiun-bg-white qiun-title-bar qiun-common-mt" >
			<view class="qiun-title-dot-light">平均消费</view>
		</view>
		</canvas>
		...
		<view class="qiun-bg-white qiun-title-bar qiun-common-mt" >
			<view class="qiun-title-dot-light">顾客占比</view>
		</view>
			...
			export default {
				...
				methods: {
						getServerData(){
								...
								uni.request({
									url: this.baseURL + 'getfooddataimg?cityId=' + this.cityId,
									success:res=>{
										...
										// let Column={categories:["1","2","3","4","5"],series:[{"name":"评分","data":[4.7,4.8,4.9,5.0,4.6]}]};
										...
										Column.categories = res.data.data.siteName
										Column.series[0].data = res.data.data.points
										// let Column2={categories:[1,2,3,4,55],series:[{"name":"评分","data":[4.7,4.8,4.9,5.0,4.6]}]}
										// let Pie = {series:[{"name":"打字员","data":50},{"name":"人2","data":39}]}
										let Pie = {series: []}
										Pie.series = res.data.data.data
										// let LineA={categories:["1","2","3","4","5"],series:[{"name":"评分","data":[4.7,4.8,4.9,5.0,4.6]}]};
										let LineA = {categories: [],series: [{"name":"平均消费",data:[]}]}
										LineA.categories = res.data.data.siteName
										LineA.series[0].data = res.data.data.price
